...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url(); ?>assets/icon/book.png">

    <title>SISFO PERPUSTAKAAN<?= $title ?></title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>home">
                <div class="sidebar-brand-icon ">
                    <img src="<?= base_url(); ?>assets/icon/book.png" width="50">
                </div>
            ...
            <?php if($this->session->userdata('level') == 'Administrasi' || $this->session->userdata('level') == 'Petugas' || $this->session->userdata('level') == 'Siswa'): ?>
            ...
            <?php if($this->session->userdata('level') == 'Administrasi' || $this->session->userdata('level') == 'Petugas' ||  $this->session->userdata('level') == 'Kepala'): ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url() ?>lapeminjaman">Ulasan Buku</a>
                    </div>
